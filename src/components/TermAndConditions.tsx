      ...
      <div className="max-w-4xl mt-2.5 mx-auto px-4 py-17 space-y-2">
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc">
            ...
            <li className="list-outside">
              <p className="text-justify">
                ...
                in this Agreement) refers to Appykan Technologies Private
                Limited, Shop No. 7, Ground Floor, First Tower, Agra Road, Dausa
                - 303303.
              </p>
            </li>
            <li className="list-outside">
          ...
          <p className="text-justify">
            ...
            specifically interstitial and app open ads. Non-personalized ads do
            not use Your personal information, such as browsing history, to
            tailor advertisements.
          </p>
          <p className="text-justify">
            Google may still use cookies or similar technologies for frequency
            capping, aggregated ad reporting, and to combat fraud and abuse. For
