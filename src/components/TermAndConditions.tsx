        ...
        <div className="max-w-4xl mt-2.5 mx-auto p-8 md:p-4 space-y-2">
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc">
              ...
              <li className="list-outside">
                <p className="text-justify">
                  <strong>Application</strong> refers to Wordum, the software
              ...
              <li className="list-outside">
                <p className="text-justify">
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Appykan
                  Technologies Private Limited, Shop No. 7, Ground Floor, First
                  Tower, Agra Road, Dausa - 303303.
                </p>
              </li>
              <li className="list-outside">
                <p className="text-justify">
            ...
            <h3 className="text-xl">Advertising and Data Usage</h3>
            <p className="text-justify">
              We only serve non-personalized ads through Google AdMob,
              specifically interstitial and app open ads. Non-personalized ads
              do not use Your personal information, such as browsing history, to
              tailor advertisements.
            </p>
            <p className="text-justify">
              Google may still use cookies or similar technologies for frequency
              capping, aggregated ad reporting, and to combat fraud and abuse.
            ...
            <ul className="list-disc">
              ...
              <li className="list-outside">Protect against legal liability</li>
            </ul>
            ...
            <ul className="list-disc">
              <li className="list-outside">
                <p className="text-justify">By email: support@appykan.com</p>
              </li>
              <li className="list-outside">
                <p className="text-justify">
                  By visiting this page on our website:{" "}
                  <a
                    href="https://www.appykan.com/contact-us"
                    rel="external nofollow noopener noreferrer"
                    target="_blank"
                  >
                    https://www.appykan.com/contact-us
                  </a>
                </p>
              </li>
            </ul>
