...
export default function UserGameCreatePage() {
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col items-center gap-9 bg-[#F4C9EC]">
      <div className="hidden md:block w-full">
        <Header />
      </div>
      {/* Header Section */}
      <div className="relative w-full flex items-center py-2 px-2 gap-9 text-sm md:hidden">
      ...
      {/* Grid */}
      <div className="w-full px-2 sm:px-0 flex flex-col items-center gap-6 md:gap-3 md:mb-2">
        {/* Grid Section */}
